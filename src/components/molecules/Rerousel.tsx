...
const Images: { imageUrl: string; link: string; key: string }[] = [
    ...
    },
    {
        ...
        link: 'https://github.com/AleksanderBondar',
        key: '4',
    },
    {
    ...
    },
    {
        ...
        link: 'https://www.facebook.com/aleksander.bondar/',
        key: '11',
    },
    {
        imageUrl:
            'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/TeamSpeak_textlogo.svg/1920px-TeamSpeak_textlogo.svg.png',
        link: 'https://www.teamspeak.com/en/',
        key: '12',
    },
];
...
export const Techbar: React.FC<LogoCloudProps> = ({ images }) => {
    ...
    return (
            <TechBackground>
                    <Rerousel itemRef={customerLogo} interval={5000} stop={false}>
